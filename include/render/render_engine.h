...
public:
    ...
    // Dynamic scene synchronization for GPU acceleration
    void sync_scene_changes_to_gpu();
    void set_auto_gpu_sync(bool enabled);
    bool is_auto_gpu_sync_enabled() const;
...
private:
    ...
    // Dynamic scene GPU synchronization
    bool auto_gpu_sync_enabled_;
    std::chrono::steady_clock::time_point last_scene_sync_;
    size_t last_scene_object_count_;
